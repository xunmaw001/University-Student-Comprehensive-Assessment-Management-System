	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>人数</label>
					<input name="renshu" id="renshu" name="renshu" class="form-control" placeholder="请输入人数">
				</div>
				<div class="form-item">
					<label>班主任</label>
					<input name="banzhuren" id="banzhuren" name="banzhuren" class="form-control" placeholder="请输入班主任">
				</div>
				<div class="form-item">
					<label>联系电话</label>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.banzhuren != null && res.data.banzhuren != ''){
						...
						$("#banzhuren").attr('readonly','readonly');
					}
