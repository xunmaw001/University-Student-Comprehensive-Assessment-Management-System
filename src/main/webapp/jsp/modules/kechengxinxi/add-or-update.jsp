...
<body>
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>课程范畴</label>
					<input name="kechengfanchou" id="kechengfanchou" name="kechengfanchou" class="form-control" placeholder="请输入课程范畴">
				</div>
				<div class="form-item">
					<label>课程介绍</label>
					<textarea  name="kechengjieshao" class="form-control textarea" id="kechengjieshao" rows="3"></textarea>
				</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#kechengfanchou").val(ruleForm.kechengfanchou);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.kechengfanchou != null && res.data.kechengfanchou != ''){

						$("#kechengfanchou").val(res.data.kechengfanchou);
						$("#kechengfanchou").attr('readonly','readonly');
					}
