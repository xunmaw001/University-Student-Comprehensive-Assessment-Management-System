...
<body>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('kechengfanchou')">课程范畴<i id="kechengfanchouIcon" class="fa fa-sort"></i></th>
						<th>课程介绍</th>
						<th>操作</th>
					</tr>
				</thead>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var kechengfanchouCell  = document.createElement('td');

						 kechengfanchouCell.innerHTML = item.kechengfanchou;

			row.appendChild(kechengfanchouCell);
